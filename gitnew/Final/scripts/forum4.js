...
const preMadeComments = [
    {
        name: "Anonymous",
        message: "Und ich schau in deine Augen doch du siehst mich nicht. Ich halte deine Hand aber du fühlst mich nicht. Ich weiß nicht ob du weißt was du für mich bist. Alles was ich mache mach ich nur für.",
    ...
    {
        name: "Anonymous",
        message: "Nur für dich. Was du für mich bist. Nur für dich.",
...
// Usage:
const pageID = "page4"; // Unique identifier for each HTML page
